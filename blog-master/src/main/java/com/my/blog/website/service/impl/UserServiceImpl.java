...
//            用户密码加密
	...
	@Override
	public UserVo findUserByUsername(String username,String email) {
		UserVoExample example = new UserVoExample();
		UserVoExample.Criteria c = example.createCriteria();
		UserVoExample.Criteria c1 = example.createCriteria();
		c.andUsernameEqualTo(username);
		c1.andEmailEqualTo(email);
		example.or(c1);
		List<UserVo> list = userDao.selectByExample(example);
